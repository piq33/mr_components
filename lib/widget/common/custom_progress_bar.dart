...
class ProgressBar extends LeafRenderObjectWidget {
  ...
  const ProgressBar({
    ...
    this.barHeight = 5.0,
    this.baseBarColor,
    this.baseBarBorderColor,
    this.baseBarBorderWidth = 0,
  ...
  /// The border color of the progress bar before playback has started.
  ///
  /// By default it is transparent color.
  final Color? baseBarBorderColor;

  /// The border width of the progress bar before playback has started.
  ///
  /// By default it is 0.
  final double baseBarBorderWidth;
  ...
  /// The border color of the circle for the moveable progress bar thumb.
  ///
  /// By default it is transparent color.
  final Color? thumbBorderColor;

  /// The border width of the circle for the moveable progress bar thumb.
  ///
  /// By default it is 0.
  ...
  RenderObject createRenderObject(BuildContext context) {
    ...
    return _RenderProgressBar(
      ...
      baseBarBorderColor: baseBarBorderColor ?? Colors.transparent,
      baseBarBorderWidth: baseBarBorderWidth,
...
class _RenderProgressBar extends RenderBox {
  _RenderProgressBar({
    ...
    required Color baseBarBorderColor,
    double baseBarBorderWidth = 0,
    ...
    double textScaleFactor = 1.0,
        ...
        _baseBarBorderColor = baseBarBorderColor,
        _baseBarBorderWidth = baseBarBorderWidth,
  ...
  Color get baseBarBorderColor => _baseBarBorderColor;
  Color _baseBarBorderColor;
  set baseBarBorderColor(Color value) {
    if (_baseBarBorderColor == value) return;
    _baseBarBorderColor = value;
    markNeedsPaint();
  }

  double get baseBarBorderWidth => _baseBarBorderWidth;
  double _baseBarBorderWidth;
  set baseBarBorderWidth(double value) {
    if (_baseBarBorderWidth == value) return;
    _baseBarBorderWidth = value;
    markNeedsPaint();
  }
  ...
  double get thumbBorderWidth => _thumbBorderWidth;
  double _thumbBorderWidth;
  set thumbBorderWidth(double value) {
    if (_thumbBorderWidth == value) return;
  ...
  void _drawProgressBar(Canvas canvas, Offset offset, Size localSize) {
    ...
    if (baseBarBorderWidth > 0) {
      _drawBarBorder(
        canvas: canvas,
        availableSize: localSize,
        widthProportion: 1.0,
        color: baseBarBorderColor,
      );
    }
  ...
  void _drawBarBorder({
    ...
    final strokeCap = (_barCapShape == BarCapShape.round)
        ? StrokeCap.round
        : StrokeCap.square;
    final baseBarBorderPaint = Paint()
      ..color = baseBarBorderColor
      ..strokeCap = strokeCap
      ..strokeWidth = baseBarBorderWidth
      ..style = PaintingStyle.stroke;
    final capRadius = _barHeight / 2;
    final rrect = RRect.fromLTRBR(
      0,
      thumbRadius - capRadius,
      availableSize.width,
      thumbRadius + capRadius,
      Radius.circular(_barHeight),
    );
    canvas.drawRRect(rrect, baseBarBorderPaint);
  }
