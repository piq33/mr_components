...
abstract class $CommentReqCopyWith<$Res> {
  ...
  @useResult
  $Res call({String knowledgeId, String commentContent, String? parentId});
}
...
class _$CommentReqImpl extends _CommentReq {
  const _$CommentReqImpl(
      {required this.knowledgeId, required this.commentContent, this.parentId})
      : super._();
  ...
  @override
  String toString() {
    return 'CommentReq(knowledgeId: $knowledgeId, commentContent: $commentContent, parentId: $parentId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, knowledgeId, commentContent, parentId);
...
abstract class _CommentReq extends CommentReq {
  const factory _CommentReq(
      {required final String knowledgeId,
...
abstract class $CommentModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      String? contactPhone,
      @JsonKey(name: 'ifSelfLike') bool selfLike,
      int selfLikeNum,
      int likeNum,
...
class _$CommentModelImpl extends _CommentModel {
  const _$CommentModelImpl(
      ...
      this.contactPhone,
      @JsonKey(name: 'ifSelfLike') this.selfLike = false,
      this.selfLikeNum = 0,
      this.likeNum = 0,
...
abstract class _CommentModel extends CommentModel {
  const factory _CommentModel(
          ...
          final String? contactPhone,
          @JsonKey(name: 'ifSelfLike') final bool selfLike,
          final int selfLikeNum,
          final int likeNum,
