...
mixin _$PhotoStore on PhotoBase, Store {
  ...
  ObservableList<ResourceWrapper> get images => (_$imagesComputed ??=
          Computed<ObservableList<ResourceWrapper>>(() => super.images,
              name: 'PhotoBase.images'))
      .value;

  late final _$fetchDataFutureAtom =
      Atom(name: 'PhotoBase.fetchDataFuture', context: context);

  @override
  ObservableFuture<BslResponse<List<PhotoResourceModel>>?> get fetchDataFuture {
  ...
  @override
  set fetchDataFuture(
      ObservableFuture<BslResponse<List<PhotoResourceModel>>?> value) {
  ...
  late final _$fetchDataAsyncAction =
      AsyncAction('PhotoBase.fetchData', context: context);
