...
class AlbumCommentController extends ListController<CommentModel> {
  AlbumCommentController(this.activityId);

  final _repository = Get.find<RepositoryService>().albumRepository;
