import 'package:bsl/component/me/formal/formal_quick_entrance.dart';
...
import 'package:bsl/widget/me/editable_button.dart';
import 'package:bsl/widget/me/school_account.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() {
            ...
            return FormalQuickEntrance(
              key: ValueKey('${student.uniqueId}QuickEntrance'),
              student: student,
            );
          }),
        ],
