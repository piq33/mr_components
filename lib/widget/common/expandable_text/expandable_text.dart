  ...
  Widget build(BuildContext context) {
    ...
    Widget result = LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        TextSpan collapseTextSpan;
        TextSpan expandTextSpan;
        if (textPainter.didExceedMaxLines) {
          ...
          final collapseText = _textSegments.isNotEmpty
              ? TextSpan(
              ...
              : TextSpan(
                  text: widget.text.substring(0, max(endOffset, 0)),
                  recognizer: recognizer,
                );

          final expandText = _textSegments.isNotEmpty
              ? TextSpan(
                  children: _buildTextSpans(
                      _textSegments, effectiveTextStyle!, recognizer),
                )
              : TextSpan(
                  text: widget.text,
                  recognizer: recognizer,
          ...
          collapseTextSpan = content;
          expandTextSpan = content;
        }

        final collapseRichText = RichText(
          text: collapseTextSpan,
          softWrap: true,
          textDirection: textDirection,
          textAlign: textAlign,
          textScaleFactor: textScaleFactor,
        ...
        if (widget.animation) {
          return AnimatedCrossFade(
            ...
            firstChild: collapseRichText,
            secondChild: expandRichText,
            firstCurve: Curves.linearToEaseOut,
            secondCurve: Curves.linearToEaseOut,
            sizeCurve: widget.animationCurve ?? Curves.linear,
        ...
        return _expanded ? expandRichText : collapseRichText;
      },
    );
