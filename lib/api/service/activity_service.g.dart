...
class _ActivityRemoteApi implements ActivityRemoteApi {
  _ActivityRemoteApi(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<BslResponse<List<ActivityModel>>> fetchActivityBySchoolCode({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BslResponse<List<ActivityModel>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BslResponse<List<ActivityModel>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<ActivityModel>(
                  (i) => ActivityModel.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return value;
